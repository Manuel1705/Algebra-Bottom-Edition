...
\bottomp{
    ...
    Se \(n > |m|\). Consideriamo vero $\forall i\in \mathbb N\ |m|\le i<n$. Allora prendiamo \(n - |m| < n\), e quindi per ipotesi induttiva $$\exists q_1, r_1\ (n - |m| = mq_1 + r_1 \land 0 \leq r_1 < |m|)$$
    Quindi \(n = mq_1 + |m| + r_1\).
...
\bottomp{
    ...
    $$ax \equiv_m b \iff [a]_m[x]_m = [b]_m \iff a'x \equiv_m b'$$
}
